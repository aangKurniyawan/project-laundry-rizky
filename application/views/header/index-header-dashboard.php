        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="<?php echo base_url('laporantransaksi');?>"><i class="fa fa-circle-o"></i> Laporan Transaksi</a></li>
                <li><a href="<?php echo base_url('laporanpembayaran');?>"><i class="fa fa-circle-o"></i>  Laporan Pembayaran</a></li>
              </ul>
            </li>
            <li>
