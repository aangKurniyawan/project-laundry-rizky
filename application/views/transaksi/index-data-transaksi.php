                      ...
                      ?>
                        <tr>
                          ...
                          <a class="btn btn-xs btn-success" href="<?php echo base_url('frombayartransaksi/'.$transaksi->id_transaksi);?>"><i class="fa fa-money"></i> Bayar</a>
                            <a class="btn btn-xs btn-warning" href="<?php echo base_url('formeditjenislaundry/'.$transaksi->id_transaksi);?>"><i class="fa fa-edit"></i> Edit</a>
                            <a class="btn btn-xs btn-danger" data-toggle="modal" data-target="#modalhapus_<?php echo $transaksi->id_transaksi;?>"><i class="fa fa-trash"></i> Hapus</a>
                          </td>
                        </tr>
                      <?php } ?>
                    </tbody>
