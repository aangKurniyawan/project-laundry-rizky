            ...
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-header">
                        <div class="box-body">
                            <form action="<?php echo base_url('carilaporanpembayaran');?>" method="POST">
                                <div class="row">
                                    <div class="col-md-4">
                                    ...
                                    <div class="col-md-4" style="padding-top:25px;!importan">
                                        <div class="form-group">
                ...
                <div class="box-body">
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tfoot>
                        <?php
                            $no=1;
                            foreach($jumlahbayar as $jumlah) {
                        ?>
                            <tr>
                                <td colspan="6"></td>
                                <td>Total Bayar :</td>
                                <td><?php echo number_format($jumlah->total_pendapatan);?></td>
                                <td colspan="2"></td>
                            </tr>
                        <?php } ?>
                    </tfoot>
