<div class="content-wrapper">
        ...
        <section class="content">
          ...
          <div class="box box-default">
            ...
            <div class="box-body">
                <form action="<?php echo base_url('insertjenislaundry');?>" method="POST">
                    <div class="row">
                        <div class="col-md-3">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="number" name="harga_jenis_laundry" class="form-control" required>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>Deskripsi Jenis Laundry</label>
                                <input type="text" name="deskripsi_jenis_laundry" class="form-control" required>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
