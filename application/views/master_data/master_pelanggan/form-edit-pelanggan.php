            ...
            <div class="box-header with-border">
              <h3 class="box-title">Form Edit Pelanggan</h3>
                <div class="box-tools pull-right">
                    <a href="<?php echo base_url('masterpelanggan');?>" class="btn btn-sm btn-success"><i class="fa fa-reply"></i> Kembali</a>
                </div>
            </div><!-- /.box-header -->
            <div class="box-body">
                <?php foreach($editpelanggan as $edit){ ?>
                    <form action="<?php echo base_url('updatepelanggan');?>" method="POST">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="no_telepon_pelanggan" value="<?php echo $edit->no_telepon_pelanggan;?>" class="form-control" required>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label>Email Pelanggan</label>
                                    <input type="email" name="email_pelanggan" value="<?php echo $edit->email_pelanggan;?>" class="form-control" required>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label><font size="1">Password Pelanggan (kosongkan jika tidak ada perubahan)</font></label>
                                    <input type="password" name="password_pelanggan_baru" class="form-control" >
                                </div>
                            </div>
                            <div class="col-md-8">
                                <div class="form-group">
